 ...
 */
Sidebar = function(editorUi, container)
{
	...
	if (this.taglist != null && tags != null && tags.length > 0)
	{
		...
		var doAddEntry = mxUtils.bind(this, function(tag)
		{
			if (tag.length > 1)
			{
				...
				if (entry == null)
				{
					entry = {entries: [], dict: new mxg.mxDictionary()};
	...
	if (this.taglist != null && searchTerms != null)
	{
		...
		for (var i = 0; i < tmp.length; i++)
		{
			if (tmp[i].length > 0)
			{
				...
				var tmpDict = new mxg.mxDictionary();
...
Sidebar.prototype.addGeneralPalette = function(expand)
{
	var fns = [
 		...
 		this.createVertexTemplateEntry('shape=ellipse;whiteSpace=wrap;html=1;', 120, 80, '', 'Ellipse', null, null, 'oval ellipse state'),
	 	...
	 	this.createVertexTemplateEntry('shape=ellipse;shape=doubleEllipse;whiteSpace=wrap;html=1;', 120, 80, '', 'Double Ellipse', null, null, 'oval ellipse start end state double'),
		this.createVertexTemplateEntry('shape=rhombus;whiteSpace=wrap;html=1;', 80, 80, '', 'Diamond', null, null, 'diamond rhombus if condition decision conditional question test'),
		...
		this.createVertexTemplateEntry('shape=ellipse;whiteSpace=wrap;html=1;aspect=fixed;', 80, 80, '', 'Circle', null, null, 'circle'),
		this.createVertexTemplateEntry('shape=doubleEllipse;whiteSpace=wrap;html=1;aspect=fixed;', 80, 80, '', 'Double Circle', null, null, 'double circle'),


		this.createVertexTemplateEntry('shape=parallelogram;whiteSpace=wrap;html=1;', 120, 60, '', 'Parallelogram'),
	 	this.createVertexTemplateEntry('shape=triangle;whiteSpace=wrap;html=1;', 60, 80, '', 'Triangle', null, null, 'triangle logic inverter buffer'),
	 	...
	 	this.createVertexTemplateEntry('shape=ellipse;shape=cloud;whiteSpace=wrap;html=1;', 120, 80, '', 'Cloud', null, null, 'cloud network'),
...
Sidebar.prototype.addBasicPalette = function(dir)
{
	this.addStencilPalette('basic', mxResources.get('basic'), dir + '/basic.xml',
		...
		this.createVertexTemplateEntry('shape=ellipse;whiteSpace=wrap;html=1;aspect=fixed;', 80, 80, '', 'Circle', null, null, 'circle'),
		this.createVertexTemplateEntry('shape=ext;double=1;whiteSpace=wrap;html=1;aspect=fixed;', 80, 80, '', 'Double Square', null, null, 'double square'),
		this.createVertexTemplateEntry('shape=ellipse;shape=doubleEllipse;whiteSpace=wrap;html=1;aspect=fixed;', 80, 80, '', 'Double Circle', null, null, 'double circle')
	]);
};
...
Sidebar.prototype.addMiscPalette = function(expand)
{
	var fns = [
		...
		this.createVertexTemplateEntry('text;html=1;strokeColor=#c0c0c0;overflow=fill;', 180, 140,
	 	...
	 	{
	 		var cell = new mxg.mxCell('Link', new mxg.mxGeometry(0, 0, 60, 40), 'text;html=1;whiteSpace=wrap;align=center;verticalAlign=middle;fontColor=#0000EE;fontStyle=4;');
	 		cell.vertex = true;
	 	...
	 	{
	 		var cell = new mxg.mxCell('%date{ddd mmm dd yyyy HH:MM:ss}%', new mxg.mxGeometry(0, 0, 160, 20), 'text;html=1;strokeColor=none;fillColor=none;align=center;verticalAlign=middle;whiteSpace=wrap;overflow=hidden;');
	 		cell.vertex = true;
	 	...
	 	{
	 		var cell = new mxg.mxCell('%name% Text', new mxg.mxGeometry(0, 0, 80, 20), 'text;html=1;strokeColor=none;fillColor=none;align=center;verticalAlign=middle;whiteSpace=wrap;overflow=hidden;');
	 		cell.vertex = true;
	 		this.graph.setAttributeForCell(cell, 'placeholders', '1');
	 	...
	 	this.createVertexTemplateEntry('shape=rhombus;html=1;align=center;whiteSpace=wrap;comic=1;strokeWidth=2;fontFamily=Comic Sans MS;fontStyle=1;', 100, 100, 'DIAMOND', 'Comic Diamond', true, null, 'comic diamond rhombus if condition decision conditional question test retro'),
	  ...
	  this.createEdgeTemplateEntry('shape=flexArrow;endArrow=classic;startArrow=classic;html=1;fillColor=#ffffff;', 50, 50, '', 'Arrow'),
	 	...
	 	{
			var cell = new mxg.mxCell('', new mxg.mxGeometry(0, 0, 50, 50), 'curved=1;endArrow=classic;html=1;');
			cell.geometry.setTerminalPoint(new mxg.mxPoint(0, 50), true);
			cell.geometry.setTerminalPoint(new mxg.mxPoint(50, 0), false);
			cell.geometry.points = [new mxg.mxPoint(50, 50), new mxg.mxPoint(0, 0)];
...
Sidebar.prototype.createAdvancedShapes = function()
{
	...
	// Reusable cells
	var field = new mxg.mxCell('List Item', new mxg.mxGeometry(0, 0, 60, 26), 'text;html=1;strokeColor=none;fillColor=none;align=left;verticalAlign=top;spacingLeft=4;spacingRight=4;whiteSpace=wrap;overflow=hidden;rotatable=0;points=[[0,0.5],[1,0.5]];portConstraint=eastwest;');
	field.vertex = true;
	...
	return [
		...
		{
			var cell = new mxg.mxCell('List', new mxg.mxGeometry(0, 0, 140, 110),
...
Sidebar.prototype.addUmlPalette = function(expand)
{
	...
	// Reusable cells
	var field = new mxg.mxCell('+ field: type', new mxg.mxGeometry(0, 0, 100, 26), 'text;html=1;strokeColor=none;fillColor=none;align=left;verticalAlign=top;spacingLeft=4;spacingRight=4;whiteSpace=wrap;overflow=hidden;rotatable=0;points=[[0,0.5],[1,0.5]];portConstraint=eastwest;');
	field.vertex = true;

	var divider = new mxg.mxCell('', new mxg.mxGeometry(0, 0, 40, 8), 'line;html=1;strokeWidth=1;fillColor=none;align=left;verticalAlign=middle;spacingTop=-1;spacingLeft=3;spacingRight=3;rotatable=0;labelPosition=right;points=[];portConstraint=eastwest;');
	divider.vertex = true;
	...
	var fns = [
		...
		{
			var cell = new mxg.mxCell('Classname', new mxg.mxGeometry(0, 0, 160, 90),
		...
		{
			var cell = new mxg.mxCell('Classname', new mxg.mxGeometry(0, 0, 140, 110),
		    	'swimlane;html=1;fontStyle=0;childLayout=stackLayout;horizontal=1;startSize=26;fillColor=none;horizontalStack=0;resizeParent=1;resizeLast=0;collapsible=1;marginBottom=0;swimlaneFillColor=#ffffff;');
			cell.vertex = true;
			cell.insert(field.clone());
			cell.insert(field.clone());
		...
		this.addEntry(dt + 'item member method function variable field attribute label', function()
		{
   		...
   		this.addEntry(dt + 'item member method function variable field attribute label', function()
		{
   			var cell = new mxg.mxCell('item: attribute', new mxg.mxGeometry(0, 0, 120, field.geometry.height), 'label;html=1;fontStyle=0;strokeColor=none;fillColor=none;align=left;verticalAlign=top;overflow=hidden;' +
		...
		{
			var cell = new mxg.mxCell('', new mxg.mxGeometry(0, 0, 20, 14), 'text;html=1;strokeColor=none;fillColor=none;align=left;verticalAlign=middle;spacingTop=-1;spacingLeft=4;spacingRight=4;rotatable=0;labelPosition=right;points=[];portConstraint=eastwest;');
			cell.vertex = true;
		...
		{
		    var cell = new mxg.mxCell('&laquo;Annotation&raquo;<br/><b>Component</b>', new mxg.mxGeometry(0, 0, 180, 90), 'html=1;');
		    cell.vertex = true;

			var symbol = new mxg.mxCell('', new mxg.mxGeometry(1, 0, 20, 20), 'shape=component;jettyWidth=8;jettyHeight=4;');
			symbol.vertex = true;
			symbol.geometry.relative = true;
			symbol.geometry.offset = new mxg.mxPoint(-27, 7);
			cell.insert(symbol);
		...
		this.addEntry(dt + 'component', function()
		{
		    var cell = new mxg.mxCell('<p style="margin:0px;margin-top:6px;text-align:center;"><b>Component</b></p>' +
				'<hr/><p style="margin:0px;margin-left:8px;">+ Attribute1: Type<br/>+ Attribute2: Type</p>', new mxg.mxGeometry(0, 0, 180, 90),
			...
			symbol.vertex = true;
			symbol.geometry.relative = true;
			symbol.geometry.offset = new mxg.mxPoint(-24, 4);
			cell.insert(symbol);
		...
		this.addEntry(dt + 'object instance', function()
		{
		    var cell = new mxg.mxCell('<p style="margin:0px;margin-top:4px;text-align:center;">' +
	    			'<b>Class</b></p>' +
					'<hr size="1"/><div style="height:2px;"></div>', new mxg.mxGeometry(0, 0, 140, 60),
		...
		this.addEntry(dt + 'object instance', function()
		{
		    var cell = new mxg.mxCell('<p style="margin:0px;margin-top:4px;text-align:center;">' +
	    			'<b>Class</b></p>' +
					'<hr size="1"/><div style="height:2px;"></div><hr size="1"/><div style="height:2px;"></div>', new mxg.mxGeometry(0, 0, 140, 60),
					'verticalAlign=top;align=left;overflow=fill;fontSize=12;fontFamily=Helvetica;html=1;');
		    cell.vertex = true;
		...
		this.addEntry(dt + 'object instance', function()
		{
		    var cell = new mxg.mxCell('<p style="margin:0px;margin-top:4px;text-align:center;">' +
					...
					'<p style="margin:0px;margin-left:4px;">+ method(): Type</p>', new mxg.mxGeometry(0, 0, 160, 90),
					'verticalAlign=top;align=left;overflow=fill;fontSize=12;fontFamily=Helvetica;html=1;');
		    cell.vertex = true;
		...
		this.addEntry(dt + 'object instance', function()
		{
		    var cell = new mxg.mxCell('<p style="margin:0px;margin-top:4px;text-align:center;">' +
					...
					'+ method2(Type, Type): Type</p>', new mxg.mxGeometry(0, 0, 190, 140),
					'verticalAlign=top;align=left;overflow=fill;fontSize=12;fontFamily=Helvetica;html=1;');
		    cell.vertex = true;
		...
		{
	    	var cell = new mxg.mxCell('', new mxg.mxGeometry(0, 0, 30, 30),
	    		'ellipse;html=1;shape=startState;fillColor=#000000;strokeColor=#ff0000;');
	    	cell.vertex = true;

			var edge = new mxg.mxCell('', new mxg.mxGeometry(0, 0, 0, 0), 'edgeStyle=orthogonalEdgeStyle;html=1;verticalAlign=bottom;endArrow=open;endSize=8;strokeColor=#ff0000;');
			edge.geometry.setTerminalPoint(new mxg.mxPoint(15, 90), false);
		...
		{
			var cell = new mxg.mxCell('Activity', new mxg.mxGeometry(0, 0, 120, 40),
				'rounded=1;whiteSpace=wrap;html=1;arcSize=40;fillColor=#ffffc0;strokeColor=#ff0000;');
			cell.vertex = true;

			var edge = new mxg.mxCell('', new mxg.mxGeometry(0, 0, 0, 0), 'edgeStyle=orthogonalEdgeStyle;html=1;verticalAlign=bottom;endArrow=open;endSize=8;strokeColor=#ff0000;');
			edge.geometry.setTerminalPoint(new mxg.mxPoint(60, 100), false);
			edge.geometry.relative = true;
			edge.edge = true;
		...
		{
			var cell = new mxg.mxCell('Composite State', new mxg.mxGeometry(0, 0, 160, 60),
			...
			var cell1 = new mxg.mxCell('Subtitle', new mxg.mxGeometry(0, 0, 200, 26), 'text;html=1;strokeColor=none;fillColor=none;align=center;verticalAlign=middle;spacingLeft=4;spacingRight=4;whiteSpace=wrap;overflow=hidden;rotatable=0;');
			cell1.vertex = true;
			cell.insert(cell1);

			var edge = new mxg.mxCell('', new mxg.mxGeometry(0, 0, 0, 0), 'edgeStyle=orthogonalEdgeStyle;html=1;verticalAlign=bottom;endArrow=open;endSize=8;strokeColor=#ff0000;');
			edge.geometry.setTerminalPoint(new mxg.mxPoint(80, 120), false);
			edge.geometry.relative = true;
			edge.edge = true;
		...
		{
	    	var cell = new mxg.mxCell('Condition', new mxg.mxGeometry(0, 0, 80, 40), 'rhombus;whiteSpace=wrap;html=1;fillColor=#ffffc0;strokeColor=#ff0000;');
	    	cell.vertex = true;

			var edge1 = new mxg.mxCell('no', new mxg.mxGeometry(0, 0, 0, 0), 'edgeStyle=orthogonalEdgeStyle;html=1;align=left;verticalAlign=bottom;endArrow=open;endSize=8;strokeColor=#ff0000;');
			edge1.geometry.setTerminalPoint(new mxg.mxPoint(180, 20), false);
			...
			var edge2 = new mxg.mxCell('yes', new mxg.mxGeometry(0, 0, 0, 0), 'edgeStyle=orthogonalEdgeStyle;html=1;align=left;verticalAlign=top;endArrow=open;endSize=8;strokeColor=#ff0000;');
			edge2.geometry.setTerminalPoint(new mxg.mxPoint(40, 100), false);
		...
		{
	    	var cell = new mxg.mxCell('', new mxg.mxGeometry(0, 0, 200, 10), 'shape=line;html=1;strokeWidth=6;strokeColor=#ff0000;');
	    	cell.vertex = true;

			var edge = new mxg.mxCell('', new mxg.mxGeometry(0, 0, 0, 0), 'edgeStyle=orthogonalEdgeStyle;html=1;verticalAlign=bottom;endArrow=open;endSize=8;strokeColor=#ff0000;');
			edge.geometry.setTerminalPoint(new mxg.mxPoint(100, 80), false);
			edge.geometry.relative = true;
			edge.edge = true;
		...
		{
	    	var cell = new mxg.mxCell('', new mxg.mxGeometry(0, 0, 10, 80), 'html=1;points=[];perimeter=orthogonalPerimeter;');
	    	cell.vertex = true;

			var edge = new mxg.mxCell('dispatch', new mxg.mxGeometry(0, 0, 0, 0), 'html=1;verticalAlign=bottom;startArrow=oval;endArrow=block;startSize=8;');
			edge.geometry.setTerminalPoint(new mxg.mxPoint(-60, 0), true);
			edge.geometry.relative = true;
			edge.edge = true;
		...
		this.addEntry('uml sequence invoke call delegation synchronous invocation activation', function()
		{
			...
			var edge1 = new mxg.mxCell('dispatch', new mxg.mxGeometry(0, 0, 0, 0), 'html=1;verticalAlign=bottom;endArrow=block;entryX=0;entryY=0;');
			edge1.geometry.setTerminalPoint(new mxg.mxPoint(-70, 0), true);
			edge1.geometry.relative = true;
			edge1.edge = true;

			cell.insertEdge(edge1, false);

			var edge2 = new mxg.mxCell('return', new mxg.mxGeometry(0, 0, 0, 0), 'html=1;verticalAlign=bottom;endArrow=open;dashed=1;endSize=8;exitX=0;exitY=0.95;');
			edge2.geometry.setTerminalPoint(new mxg.mxPoint(-70, 76), false);
			edge2.geometry.relative = true;
			edge2.edge = true;
		...
		{
	    	var cell = new mxg.mxCell('', new mxg.mxGeometry(0, 20, 10, 40), 'html=1;points=[];perimeter=orthogonalPerimeter;');
	    	cell.vertex = true;

			var edge = new mxg.mxCell('self call', new mxg.mxGeometry(0, 0, 0, 0), 'edgeStyle=orthogonalEdgeStyle;html=1;align=left;spacingLeft=2;endArrow=block;rounded=0;entryX=1;entryY=0;');
			edge.geometry.setTerminalPoint(new mxg.mxPoint(5, 0), true);
			edge.geometry.points = [new mxg.mxPoint(30, 0)];
			edge.geometry.relative = true;
			edge.edge = true;
		...
		{
	    	var cell = new mxg.mxCell('', new mxg.mxGeometry(0, 0, 10, 60), 'html=1;points=[];perimeter=orthogonalPerimeter;');
	    	cell.vertex = true;

			var edge1 = new mxg.mxCell('callback', new mxg.mxGeometry(0, 0, 0, 0), 'html=1;verticalAlign=bottom;endArrow=block;entryX=1;entryY=0;');
			edge1.geometry.setTerminalPoint(new mxg.mxPoint(70, 0), true);
			edge1.geometry.relative = true;
			edge1.edge = true;
			...
			var edge2 = new mxg.mxCell('return', new mxg.mxGeometry(0, 0, 0, 0), 'html=1;verticalAlign=bottom;endArrow=open;dashed=1;endSize=8;exitX=1;exitY=0.95;');
			edge2.geometry.setTerminalPoint(new mxg.mxPoint(70, 57), false);
			edge2.geometry.relative = true;
			edge2.edge = true;
		...
		{
			var edge = new mxg.mxCell('return', new mxg.mxGeometry(0, 0, 0, 0), 'html=1;verticalAlign=bottom;endArrow=open;dashed=1;endSize=8;');
			edge.geometry.setTerminalPoint(new mxg.mxPoint(80, 0), true);
			edge.geometry.setTerminalPoint(new mxg.mxPoint(0, 0), false);
			edge.geometry.relative = true;
			edge.edge = true;
		...
		{
			var edge = new mxg.mxCell('name', new mxg.mxGeometry(0, 0, 0, 0), 'endArrow=block;endFill=1;html=1;edgeStyle=orthogonalEdgeStyle;align=left;verticalAlign=top;');
			edge.geometry.setTerminalPoint(new mxg.mxPoint(0, 0), true);
			edge.geometry.setTerminalPoint(new mxg.mxPoint(160, 0), false);
			edge.geometry.relative = true;
			edge.geometry.x = -1;
			edge.edge = true;

	    	var cell = new mxg.mxCell('1', new mxg.mxGeometry(-1, 0, 0, 0), 'resizable=0;html=1;align=left;verticalAlign=bottom;labelBackgroundColor=#ffffff;fontSize=10;');
	    	cell.geometry.relative = true;
		...
		{
			var edge = new mxg.mxCell('', new mxg.mxGeometry(0, 0, 0, 0), 'endArrow=none;html=1;edgeStyle=orthogonalEdgeStyle;');
			edge.geometry.setTerminalPoint(new mxg.mxPoint(0, 0), true);
			edge.geometry.setTerminalPoint(new mxg.mxPoint(160, 0), false);
			edge.geometry.relative = true;
			edge.edge = true;

	    	var cell1 = new mxg.mxCell('parent', new mxg.mxGeometry(-1, 0, 0, 0), 'resizable=0;html=1;align=left;verticalAlign=bottom;labelBackgroundColor=#ffffff;fontSize=10;');
	    	cell1.geometry.relative = true;
	    	cell1.setConnectable(false);
	    	cell1.vertex = true;
	    	edge.insert(cell1);

	    	var cell2 = new mxg.mxCell('child', new mxg.mxGeometry(1, 0, 0, 0), 'resizable=0;html=1;align=right;verticalAlign=bottom;labelBackgroundColor=#ffffff;fontSize=10;');
		...
		{
			var edge = new mxg.mxCell('1', new mxg.mxGeometry(0, 0, 0, 0), 'endArrow=open;html=1;endSize=12;startArrow=diamondThin;startSize=14;startFill=0;edgeStyle=orthogonalEdgeStyle;align=left;verticalAlign=bottom;');
			edge.geometry.setTerminalPoint(new mxg.mxPoint(0, 0), true);
			edge.geometry.setTerminalPoint(new mxg.mxPoint(160, 0), false);
			edge.geometry.relative = true;
			edge.geometry.x = -1;
		...
		{
			var edge = new mxg.mxCell('1', new mxg.mxGeometry(0, 0, 0, 0), 'endArrow=open;html=1;endSize=12;startArrow=diamondThin;startSize=14;startFill=1;edgeStyle=orthogonalEdgeStyle;align=left;verticalAlign=bottom;');
			edge.geometry.setTerminalPoint(new mxg.mxPoint(0, 0), true);
			edge.geometry.setTerminalPoint(new mxg.mxPoint(160, 0), false);
			edge.geometry.relative = true;
			edge.geometry.x = -1;
		...
		this.addEntry('uml relation', function()
		{
			var edge = new mxg.mxCell('Relation', new mxg.mxGeometry(0, 0, 0, 0), 'endArrow=open;html=1;endSize=12;startArrow=diamondThin;startSize=14;startFill=0;edgeStyle=orthogonalEdgeStyle;');
			edge.geometry.setTerminalPoint(new mxg.mxPoint(0, 0), true);
			edge.geometry.setTerminalPoint(new mxg.mxPoint(160, 0), false);
			edge.geometry.relative = true;
			edge.edge = true;

	    	var cell1 = new mxg.mxCell('0..n', new mxg.mxGeometry(-1, 0, 0, 0), 'resizable=0;html=1;align=left;verticalAlign=top;labelBackgroundColor=#ffffff;fontSize=10;');
	    	cell1.geometry.relative = true;
	    	cell1.setConnectable(false);
	    	cell1.vertex = true;
	    	edge.insert(cell1);

	    	var cell2 = new mxg.mxCell('1', new mxg.mxGeometry(1, 0, 0, 0), 'resizable=0;html=1;align=right;verticalAlign=top;labelBackgroundColor=#ffffff;fontSize=10;');
	    	cell2.geometry.relative = true;
	    	cell2.setConnectable(false);
	    	cell2.vertex = true;
	    	edge.insert(cell2);
...
Sidebar.prototype.addBpmnPalette = function(dir, expand)
{
	...
	[
		...
		{
			var cell = new mxg.mxCell('Sub-Process', new mxg.mxGeometry(0, 0, 120, 80), 'html=1;whiteSpace=wrap;rounded=1;');
			cell.vertex = true;

			var cell1 = new mxg.mxCell('', new mxg.mxGeometry(0.5, 1, 14, 14), 'html=1;shape=plus;');
			cell1.vertex = true;
			cell1.geometry.relative = true;
			cell1.geometry.offset = new mxg.mxPoint(-7, -14);
			cell.insert(cell1);
		...
		{
			var cell = new mxg.mxCell('Looped\nSub-Process', new mxg.mxGeometry(0, 0, 120, 80), 'html=1;whiteSpace=wrap;rounded=1');
			cell.vertex = true;

			var cell1 = new mxg.mxCell('', new mxg.mxGeometry(0.5, 1, 14, 14), 'html=1;shape=mxgraph.bpmn.loop;');
			cell1.vertex = true;
			cell1.geometry.relative = true;
			cell1.geometry.offset = new mxg.mxPoint(-15, -14);
			cell.insert(cell1);

			var cell2 = new mxg.mxCell('', new mxg.mxGeometry(0.5, 1, 14, 14), 'html=1;shape=plus;');
			cell2.vertex = true;
			cell2.geometry.relative = true;
			cell2.geometry.offset = new mxg.mxPoint(1, -14);
			cell.insert(cell2);
		...
		{
			var cell = new mxg.mxCell('Receive', new mxg.mxGeometry(0, 0, 120, 80), 'html=1;whiteSpace=wrap;rounded=1;');
			cell.vertex = true;

			var cell1 = new mxg.mxCell('', new mxg.mxGeometry(0, 0, 20, 14), 'html=1;shape=message;');
			cell1.vertex = true;
			cell1.geometry.relative = true;
			cell1.geometry.offset = new mxg.mxPoint(7, 7);
			cell.insert(cell1);
		...
		{
			var cell = new mxg.mxCell('User', new mxg.mxGeometry(0, 0, 120, 80), 'html=1;whiteSpace=wrap;rounded=1;');
			cell.vertex = true;

			var cell1 = new mxg.mxCell('', new mxg.mxGeometry(0, 0, 14, 14), 'html=1;shape=mxgraph.bpmn.user_task;');
			cell1.vertex = true;
			cell1.geometry.relative = true;
			cell1.geometry.offset = new mxg.mxPoint(7, 7);
			cell.insert(cell1);
			...
			cell2.vertex = true;
			cell2.geometry.relative = true;
			cell2.geometry.offset = new mxg.mxPoint(-7, -14);
			cell.insert(cell2);
		...
		{
			var cell = new mxg.mxCell('Process', new mxg.mxGeometry(0, 0, 120, 80), 'html=1;whiteSpace=wrap;rounded=1;');
			cell.vertex = true;

			var cell1 = new mxg.mxCell('', new mxg.mxGeometry(1, 1, 30, 30), 'shape=mxgraph.bpmn.timer_start;perimeter=ellipsePerimeter;html=1;verticalLabelPosition=bottom;labelBackgroundColor=#ffffff;verticalAlign=top;');
			cell1.vertex = true;
			cell1.geometry.relative = true;
			cell1.geometry.offset = new mxg.mxPoint(-40, -15);
			cell.insert(cell1);
		...
		this.addEntry(this.getTagsForStencil('mxgraph.bpmn', 'timer_start', 'attached').join(' '), function()
		{
			...
			var cell1 = new mxg.mxCell('', new mxg.mxGeometry(1, 0, 30, 30), 'shape=mxgraph.bpmn.timer_start;perimeter=ellipsePerimeter;html=1;labelPosition=right;labelBackgroundColor=#ffffff;align=left;');
			cell1.vertex = true;
			cell1.geometry.relative = true;
			cell1.geometry.offset = new mxg.mxPoint(-15, 10);
			cell.insert(cell1);
		...
		{
			var cell = new mxg.mxCell('', new mxg.mxGeometry(0, 0, 60, 50), 'shape=hexagon;whiteSpace=wrap;html=1;perimeter=hexagonPerimeter;');
			cell.vertex = true;
		...
		{
			var cell = new mxg.mxCell('', new mxg.mxGeometry(0, 0, 40, 60), 'shape=note;whiteSpace=wrap;size=16;html=1;');
			cell.vertex = true;

			var cell1 = new mxg.mxCell('', new mxg.mxGeometry(0, 0, 14, 14), 'html=1;shape=singleArrow;arrowWidth=0.4;arrowSize=0.4;');
			cell1.vertex = true;
			cell1.geometry.relative = true;
			cell1.geometry.offset = new mxg.mxPoint(2, 2);
			cell.insert(cell1);

			var cell2 = new mxg.mxCell('', new mxg.mxGeometry(0.5, 1, 14, 14), 'html=1;whiteSpace=wrap;shape=parallelMarker;');
			cell2.vertex = true;
			cell2.geometry.relative = true;
			cell2.geometry.offset = new mxg.mxPoint(-7, -14);
			cell.insert(cell2);
		...
		{
			var edge = new mxg.mxCell('', new mxg.mxGeometry(0, 0, 0, 0), 'startArrow=oval;startFill=0;startSize=7;endArrow=block;endFill=0;endSize=10;dashed=1;html=1;');
			edge.geometry.setTerminalPoint(new mxg.mxPoint(0, 0), true);
			edge.geometry.setTerminalPoint(new mxg.mxPoint(100, 0), false);
			edge.geometry.relative = true;
			edge.edge = true;

	    	var cell = new mxg.mxCell('', new mxg.mxGeometry(0, 0, 20, 14), 'shape=message;html=1;');
	    	cell.geometry.relative = true;
	    	cell.setConnectable(false);
	    	cell.vertex = true;
	    	cell.geometry.offset = new mxg.mxPoint(-10, -7);
	    	edge.insert(cell);
...
Sidebar.prototype.createItem = function(cells, title, showLabel, showTitle, width, height, allowCellsInserted)
{
	...
	var bounds = new mxg.mxRectangle(0, 0, width, height);
			...
			if (cells.length > 0)
			{
				...
				if (!graph.isCellLocked(target || graph.getDefaultParent()))
				{
					...
					try
					{
						...
						{
							graph.fireEvent(new mxg.mxEventObject('cellsInserted', 'cells', select));
						}
					}
					finally
					{
		...
		try
		{
			...
			if (graph.layoutManager != null)
			{
				...
				if (layout != null && layout.constructor == mxStackLayout)
				{
					...
					if (tmp != null)
					{
						var offset = new mxg.mxPoint((tmp.x / graph.view.scale - graph.view.translate.x),
			...
			else if (graph.model.isEdge(targets[dropCellIndex]))
			{
				...
				else if (useParent && graph.model.isVertex(targetParent))
				{
					...
					var offset = new mxg.mxPoint((tmpState.x / graph.view.scale - graph.view.translate.x),
			...
			graph.fireEvent(new mxg.mxEventObject('cellsInserted', 'cells', targets));
		}
		finally
		{
			graph.model.endUpdate();
		...
		else
		{
			...
			if (graph.model.isEdge(target) && geo2.getTerminalPoint(true) != null && geo2.getTerminalPoint(false) != null)
			{
				...
				if (direction == mxConstants.DIRECTION_NORTH)
				{
					geo2.height = length
					geo2.y = geo.y - length;
					geo2.setTerminalPoint(new mxg.mxPoint(geo2.x, geo2.y), false);
				}
				else if (direction == mxConstants.DIRECTION_EAST)
				{
					geo2.width = length
					geo2.x = geo.x + geo.width;
					geo2.setTerminalPoint(new mxg.mxPoint(geo2.x + geo2.width, geo2.y), false);
				}
				else if (direction == mxConstants.DIRECTION_SOUTH)
				{
					geo2.height = length
					geo2.y = geo.y + geo.height;
					geo2.setTerminalPoint(new mxg.mxPoint(geo2.x, geo2.y + geo2.height), false);
				}
	...
	dragSource.getDropTarget = mxUtils.bind(this, function(graph, x, y, evt)
	{
			...
			(graph.model.isEdge(state.cell) && graph.model.isEdge(cells[0]))))
		{
			...
			var tmp = (graph.model.isEdge(state.cell)) ? graph.view.getPoint(state) :
				new mxg.mxPoint(state.getCenterX(), state.getCenterY());
			tmp = new mxg.mxRectangle(tmp.x - this.refreshTarget.width / 2, tmp.y - this.refreshTarget.height / 2,
		...
		else if (currentStyleTarget != null && styleTargetParent != null)
		{
			...
			var tmp = (graph.model.isEdge(currentStyleTarget.cell)) ? graph.view.getPoint(currentStyleTarget) : new mxg.mxPoint(currentStyleTarget.getCenterX(), currentStyleTarget.getCenterY());
			tmp = new mxg.mxRectangle(tmp.x - this.refreshTarget.width / 2, tmp.y - this.refreshTarget.height / 2,
				this.refreshTarget.width, this.refreshTarget.height);
			checkArrow(x, y, tmp, styleTarget);
		}
		...
		if (activeTarget && currentTargetState != null && !mxEvent.isAltDown(evt) && activeArrow == null)
		{
			...
			if (graph.model.isEdge(currentTargetState.cell))
			{
				...
				{
					var p0 = pts[0];
					bbox.add(checkArrow(x, y, new mxg.mxRectangle(p0.x - this.roundDrop.width / 2,
				...
				{
					var pe = pts[pts.length - 1];
					bbox.add(checkArrow(x, y, new mxg.mxRectangle(pe.x - this.roundDrop.width / 2,
			...
			else
			{
				...
				bbox.add(checkArrow(x, y, new mxg.mxRectangle(currentTargetState.getCenterX() - this.triangleUp.width / 2,
					bds.y - this.triangleUp.height, this.triangleUp.width, this.triangleUp.height), arrowUp));
				bbox.add(checkArrow(x, y, new mxg.mxRectangle(bds.x + bds.width,
					currentTargetState.getCenterY() - this.triangleRight.height / 2,
					this.triangleRight.width, this.triangleRight.height), arrowRight));
				bbox.add(checkArrow(x, y, new mxg.mxRectangle(currentTargetState.getCenterX() - this.triangleDown.width / 2,
						bds.y + bds.height, this.triangleDown.width, this.triangleDown.height), arrowDown));
				bbox.add(checkArrow(x, y, new mxg.mxRectangle(bds.x - this.triangleLeft.width,
			...
			if (currentTargetState != null && validTarget)
			{
				...
				if (graph.model.isEdge(cell))
				{
					...
					if (pts != null)
					{
						...
						var box = new mxg.mxRectangle(x - tol, y - tol, 2 * tol, 2 * tol);
...
Sidebar.prototype.addClickHandler = function(elt, ds, cells)
{
	...
	{
		first = new mxg.mxPoint(mxEvent.getClientX(evt), mxEvent.getClientY(evt));
	});
...
{
	var cells = [new mxg.mxCell((value != null) ? value : '', new mxg.mxGeometry(0, 0, width, height), style)];
	cells[0].vertex = true;
...
{
	var cell = new mxg.mxCell((value != null) ? value : '', new mxg.mxGeometry(0, 0, width, height), style);
	cell.geometry.setTerminalPoint(new mxg.mxPoint(0, height), true);
	cell.geometry.setTerminalPoint(new mxg.mxPoint(width, 0), false);
	cell.geometry.relative = true;
	cell.edge = true;
