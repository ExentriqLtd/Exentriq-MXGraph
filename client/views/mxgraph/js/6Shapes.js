...
(function()
{
	...
	CardShape.prototype.redrawPath = function(c, x, y, w, h)
	{
		...
		this.addPoints(c, [new mxg.mxPoint(s, 0), new mxg.mxPoint(w, 0), new mxg.mxPoint(w, h), new mxg.mxPoint(0, h), new mxg.mxPoint(0, s)],
	...
	ParallelogramShape.prototype.redrawPath = function(c, x, y, w, h)
	{
		...
		var arcSize = mxUtils.getValue(this.style, mxConstants.STYLE_ARCSIZE, mxConstants.LINE_ARCSIZE) / 2;
		this.addPoints(c, [new mxg.mxPoint(0, h), new mxg.mxPoint(dx, 0), new mxg.mxPoint(w, 0), new mxg.mxPoint(w - dx, h)],
				this.isRounded, arcSize, true);
		c.end();
	};
	...
	TrapezoidShape.prototype.redrawPath = function(c, x, y, w, h)
	{
		...
		var arcSize = mxUtils.getValue(this.style, mxConstants.STYLE_ARCSIZE, mxConstants.LINE_ARCSIZE) / 2;
		this.addPoints(c, [new mxg.mxPoint(0, h), new mxg.mxPoint(dx, 0), new mxg.mxPoint(w - dx, 0), new mxg.mxPoint(w, h)],
				this.isRounded, arcSize, true);
	};
	...
	CurlyBracketShape.prototype.redrawPath = function(c, x, y, w, h)
	{
		...
		var arcSize = mxUtils.getValue(this.style, mxConstants.STYLE_ARCSIZE, mxConstants.LINE_ARCSIZE) / 2;
		this.addPoints(c, [new mxg.mxPoint(w, 0), new mxg.mxPoint(s, 0), new mxg.mxPoint(s, h / 2),
		                   new mxg.mxPoint(0, h / 2), new mxg.mxPoint(s, h / 2), new mxg.mxPoint(s, h),
		                   new mxg.mxPoint(w, h)], this.isRounded, arcSize, false);
		c.end();
	};
	...
	ProcessShape.prototype.getLabelBounds = function(rect)
	{
			...
			this.direction == mxConstants.DIRECTION_WEST))
		{
			var w = rect.width;
			var h = rect.height;
			var r = new mxg.mxRectangle(rect.x, rect.y, w, h);
	...
	StepShape.prototype.redrawPath = function(c, x, y, w, h)
	{
		var s =  w * Math.max(0, Math.min(1, parseFloat(mxUtils.getValue(this.style, 'size', this.size))));
		var arcSize = mxUtils.getValue(this.style, mxConstants.STYLE_ARCSIZE, mxConstants.LINE_ARCSIZE) / 2;
		this.addPoints(c, [new mxg.mxPoint(0, 0), new mxg.mxPoint(w - s, 0), new mxg.mxPoint(w, h / 2), new mxg.mxPoint(w - s, h),
		                   new mxg.mxPoint(0, h), new mxg.mxPoint(s, h / 2)], this.isRounded, arcSize, true);
		c.end();
	};
	...
	HexagonShape.prototype.redrawPath = function(c, x, y, w, h)
	{
		var s =  w * Math.max(0, Math.min(1, parseFloat(mxUtils.getValue(this.style, 'size', this.size))));
		var arcSize = mxUtils.getValue(this.style, mxConstants.STYLE_ARCSIZE, mxConstants.LINE_ARCSIZE) / 2;
		this.addPoints(c, [new mxg.mxPoint(s, 0), new mxg.mxPoint(w - s, 0), new mxg.mxPoint(w, 0.5 * h), new mxg.mxPoint(w - s, h),
		                   new mxg.mxPoint(s, h), new mxg.mxPoint(0, 0.5 * h)], this.isRounded, arcSize, true);
	};
	...
	mxRhombus.prototype.getLabelBounds = function(rect)
	{
		if (this.style['double'] == 1)
		{
			...
			return new mxg.mxRectangle(rect.x + margin, rect.y + margin, rect.width - 2 * margin, rect.height - 2 * margin);
		}
	...
	{
		return new mxg.mxRectangle(rect.x + rect.width / 6, rect.y, rect.width * 5 / 6, rect.height);
	};
	...
	{
		return new mxg.mxRectangle(rect.x, rect.y + rect.height / 8, rect.width, rect.height * 7 / 8);
	};
	...
	UmlLifeline.prototype.getLabelBounds = function(rect)
	{
		...
		return new mxg.mxRectangle(rect.x, rect.y, rect.width, size);
	};
	...
	UmlFrame.prototype.getLabelBounds = function(rect)
	{
		...
		return new mxg.mxRectangle(rect.x, rect.y, w, h);
	};
	...
	mxPerimeter.LifelinePerimeter = function (bounds, vertex, next, orthogonal)
	{
		...
		return new mxg.mxPoint(bounds.getCenterX() + sw, Math.min(bounds.y + bounds.height,
	...
	mxPerimeter.BackbonePerimeter = function (bounds, vertex, next, orthogonal)
	{
		...
		else
		{
			...
			return new mxg.mxPoint(Math.min(bounds.x + bounds.width, Math.max(bounds.x, next.x)),
	...
	ManualInputShape.prototype.redrawPath = function(c, x, y, w, h)
	{
		...
		var arcSize = mxUtils.getValue(this.style, mxConstants.STYLE_ARCSIZE, mxConstants.LINE_ARCSIZE) / 2;
		this.addPoints(c, [new mxg.mxPoint(0, h), new mxg.mxPoint(0, s), new mxg.mxPoint(w, 0), new mxg.mxPoint(w, h)],
				this.isRounded, arcSize, true);
		c.end();
	};
	...
	CornerShape.prototype.redrawPath = function(c, x, y, w, h)
	{
		...
		var arcSize = mxUtils.getValue(this.style, mxConstants.STYLE_ARCSIZE, mxConstants.LINE_ARCSIZE) / 2;
		this.addPoints(c, [new mxg.mxPoint(0, 0), new mxg.mxPoint(w, 0), new mxg.mxPoint(w, dy), new mxg.mxPoint(dx, dy),
		                   new mxg.mxPoint(dx, h), new mxg.mxPoint(0, h)], this.isRounded, arcSize, true);
		c.end();
	};
	...
	TeeShape.prototype.redrawPath = function(c, x, y, w, h)
	{
		...
		var s = Math.min(w / 2, Math.min(h, parseFloat(mxUtils.getValue(this.style, 'size', this.size))));
		var arcSize = mxUtils.getValue(this.style, mxConstants.STYLE_ARCSIZE, mxConstants.LINE_ARCSIZE) / 2;
		this.addPoints(c, [new mxg.mxPoint(0, 0), new mxg.mxPoint(w, 0), new mxg.mxPoint(w, dy), new mxg.mxPoint((w + dx) / 2, dy),
		                   new mxg.mxPoint((w + dx) / 2, h), new mxg.mxPoint((w - dx) / 2, h), new mxg.mxPoint((w - dx) / 2, dy),
		                   new mxg.mxPoint(0, dy)], this.isRounded, arcSize, true);
		c.end();
	};
	...
	SingleArrowShape.prototype.redrawPath = function(c, x, y, w, h)
	{
		...
		var arcSize = mxUtils.getValue(this.style, mxConstants.STYLE_ARCSIZE, mxConstants.LINE_ARCSIZE) / 2;
		this.addPoints(c, [new mxg.mxPoint(0, at), new mxg.mxPoint(w - as, at), new mxg.mxPoint(w - as, 0), new mxg.mxPoint(w, h / 2),
		                   new mxg.mxPoint(w - as, h), new mxg.mxPoint(w - as, ab), new mxg.mxPoint(0, ab)],
		                   this.isRounded, arcSize, true);
		c.end();
	};
	...
	DoubleArrowShape.prototype.redrawPath = function(c, x, y, w, h)
	{
		...
		var arcSize = mxUtils.getValue(this.style, mxConstants.STYLE_ARCSIZE, mxConstants.LINE_ARCSIZE) / 2;
		this.addPoints(c, [new mxg.mxPoint(0, h / 2), new mxg.mxPoint(as, 0), new mxg.mxPoint(as, at), new mxg.mxPoint(w - as, at),
		                   new mxg.mxPoint(w - as, 0), new mxg.mxPoint(w, h / 2), new mxg.mxPoint(w - as, h),
		                   new mxg.mxPoint(w - as, ab), new mxg.mxPoint(as, ab), new mxg.mxPoint(as, h)],
		                   this.isRounded, arcSize, true);
		c.end();
	};
	...
	LoopLimitShape.prototype.redrawPath = function(c, x, y, w, h)
	{
		var s = Math.min(w / 2, Math.min(h, parseFloat(mxUtils.getValue(this.style, 'size', this.size))));
		var arcSize = mxUtils.getValue(this.style, mxConstants.STYLE_ARCSIZE, mxConstants.LINE_ARCSIZE) / 2;
		this.addPoints(c, [new mxg.mxPoint(s, 0), new mxg.mxPoint(w - s, 0), new mxg.mxPoint(w, s * 0.8), new mxg.mxPoint(w, h),
		                   new mxg.mxPoint(0, h), new mxg.mxPoint(0, s * 0.8)], this.isRounded, arcSize, true);
		c.end();
	};
	...
	OffPageConnectorShape.prototype.redrawPath = function(c, x, y, w, h)
	{
		...
		var arcSize = mxUtils.getValue(this.style, mxConstants.STYLE_ARCSIZE, mxConstants.LINE_ARCSIZE) / 2;
		this.addPoints(c, [new mxg.mxPoint(0, 0), new mxg.mxPoint(w, 0), new mxg.mxPoint(w, h - s), new mxg.mxPoint(w / 2, h),
		                   new mxg.mxPoint(0, h - s)], this.isRounded, arcSize, true);
		c.end();
	};
	...
	if (typeof mxVertexHandler !== 'undefined')
	{
		...
		{
			var handle = new mxg.mxHandle(state, null, mxVertexHandler.prototype.secondaryHandleImage);
		...
		function createArcHandle(state, yOffset)
		{
			return createHandle(state, [mxConstants.STYLE_ARCSIZE], function(bounds)
			{
				...
				return new mxg.mxPoint(bounds.x + bounds.width - Math.min(Math.max(bounds.width / 2, bounds.height / 2),
		...
		function createTrapezoidHandleFunction(max)
		{
			return function(state)
			{
				var handles = [createHandle(state, ['size'], function(bounds)
				{
					...
					return new mxg.mxPoint(bounds.x + size * bounds.width * 0.75, bounds.y + bounds.height / 4);
				}, function(bounds, pt)
				{
		...
		function createDisplayHandleFunction(defaultValue, allowArcHandle, max)
		{
			...
			return function(state)
			{
				var handles = [createHandle(state, ['size'], function(bounds)
				{
					...
					return new mxg.mxPoint(bounds.x + size * bounds.width, bounds.getCenterY());
				}, function(bounds, pt)
				{
		...
		function createCubeHandleFunction(factor, defaultValue, allowArcHandle)
		{
			return function(state)
			{
				var handles = [createHandle(state, ['size'], function(bounds)
				{
					...
					return new mxg.mxPoint(bounds.x + size, bounds.y + size);
				}, function(bounds, pt)
				{
		...
		function createArrowHandleFunction(maxSize)
		{
			return function(state)
			{
				return [createHandle(state, ['arrowWidth', 'arrowSize'], function(bounds)
				{
					...
					return new mxg.mxPoint(bounds.x + (1 - as) * bounds.width, bounds.y + (1 - aw) * bounds.height / 2);
				}, function(bounds, pt)
				{
		...
		function createEdgeHandle(state, keys, start, getPosition, setPosition)
		{
			...
			return createHandle(state, keys, function(bounds)
			{
				...
				return new mxg.mxPoint(pt.x / s - tr.x, pt.y / s - tr.y);
			}, function(bounds, pt, me)
			{
				var dist = Math.sqrt(dx * dx + dy * dy);
				pt.x = (pt.x + tr.x) * s;
		...
		function createEdgeWidthHandle(state, start, spacing)
		{
			return createEdgeHandle(state, ['width'], start, function(dist, nx, ny, p0, p1)
			{
				...
				return new mxg.mxPoint(p0.x + nx * dist / 4 + ny * w / 2, p0.y + ny * dist / 4 - nx * w / 2);
		...
		var handleFactory = {
			...
			'flexArrow': function(state)
			{
				...
				if (mxUtils.getValue(state.style, mxConstants.STYLE_STARTARROW, mxConstants.NONE) != mxConstants.NONE)
				{
					handles.push(createEdgeHandle(state, ['width', mxConstants.STYLE_STARTSIZE, mxConstants.STYLE_ENDSIZE], true, function(dist, nx, ny, p0, p1)
					{
						...
						return new mxg.mxPoint(p0.x + nx * (l + state.shape.strokewidth * state.view.scale) + ny * w / 2,
			...
			'swimlane': function(state)
			{
				var handles = [createHandle(state, [mxConstants.STYLE_STARTSIZE], function(bounds)
				{
					...
					{
						return new mxg.mxPoint(bounds.getCenterX(), bounds.y + Math.max(0, Math.min(bounds.height, size)));
					}
					else
					{
						return new mxg.mxPoint(bounds.x + Math.max(0, Math.min(bounds.width, size)), bounds.getCenterY());
					}
				}, function(bounds, pt)
				{
			...
			'umlLifeline': function(state)
			{
				return [createHandle(state, ['size'], function(bounds)
				{
					...
					return new mxg.mxPoint(bounds.getCenterX(), bounds.y + size);
				}, function(bounds, pt)
				{
			...
			'umlFrame': function(state)
			{
				var handles = [createHandle(state, ['width', 'height'], function(bounds)
				{
					...
					return new mxg.mxPoint(bounds.x + w0, bounds.y + h0);
				}, function(bounds, pt)
				{
			...
			'process': function(state)
			{
				var handles = [createHandle(state, ['size'], function(bounds)
				{
					...
					return new mxg.mxPoint(bounds.x + bounds.width * size, bounds.y + bounds.height / 4);
				}, function(bounds, pt)
				{
			...
			'cross': function(state)
			{
				return [createHandle(state, ['size'], function(bounds)
				{
					...
					return new mxg.mxPoint(bounds.getCenterX() - size, bounds.getCenterY() - size);
				}, function(bounds, pt)
				{
					var m = Math.min(bounds.width, bounds.height);
			...
			'note': function(state)
			{
				return [createHandle(state, ['size'], function(bounds)
				{
					...
					return new mxg.mxPoint(bounds.x + bounds.width - size, bounds.y + size);
				}, function(bounds, pt)
				{
			...
			'manualInput': function(state)
			{
				var handles = [createHandle(state, ['size'], function(bounds)
				{
					...
					return new mxg.mxPoint(bounds.x + bounds.width / 4, bounds.y + size * 3 / 4);
				}, function(bounds, pt)
				{
			...
			'dataStorage': function(state)
			{
				return [createHandle(state, ['size'], function(bounds)
				{
					...
					return new mxg.mxPoint(bounds.x + (1 - size) * bounds.width, bounds.getCenterY());
				}, function(bounds, pt)
				{
			...
			'internalStorage': function(state)
			{
				var handles = [createHandle(state, ['dx', 'dy'], function(bounds)
				{
					...
					return new mxg.mxPoint(bounds.x + dx, bounds.y + dy);
				}, function(bounds, pt)
				{
			...
			'tee': function(state)
			{
				return [createHandle(state, ['dx', 'dy'], function(bounds)
				{
					...
					return new mxg.mxPoint(bounds.x + (bounds.width + dx) / 2, bounds.y + dy);
				}, function(bounds, pt)
				{
			...
			'folder': function(state)
			{
				return [createHandle(state, ['tabWidth', 'tabHeight'], function(bounds)
				{
					...
					return new mxg.mxPoint(bounds.x + tw, bounds.y + th);
				}, function(bounds, pt)
				{
			...
			'document': function(state)
			{
				return [createHandle(state, ['size'], function(bounds)
				{
					...
					return new mxg.mxPoint(bounds.x + 3 * bounds.width / 4, bounds.y + (1 - size) * bounds.height);
				}, function(bounds, pt)
				{
			...
			'tape': function(state)
			{
				return [createHandle(state, ['size'], function(bounds)
				{
					...
					return new mxg.mxPoint(bounds.getCenterX(), bounds.y + size * bounds.height / 2);
				}, function(bounds, pt)
				{
			...
			'offPageConnector': function(state)
			{
				return [createHandle(state, ['size'], function(bounds)
				{
					...
					return new mxg.mxPoint(bounds.getCenterX(), bounds.y + (1 - size) * bounds.height);
				}, function(bounds, pt)
				{
					this.state.style['size'] = Math.max(0, Math.min(1, (bounds.y + bounds.height - pt.y) / bounds.height));
				})];
	...
	else
	{
	 ...
	 var isoHVector = new mxg.mxPoint(1, 0);
	 var isoVVector = new mxg.mxPoint(1, 0);
	 ...
	 mxEdgeStyle.IsometricConnector = function (state, source, target, points, result)
	 {
		...
		if (p0 == null)
		{
			if (source != null)
			{
				p0 = new mxg.mxPoint(source.getCenterX(), source.getCenterY());
			}
		}
		...
		if (pe == null)
		{
			if (target != null)
			{
				pe = new mxg.mxPoint(target.getCenterX(), target.getCenterY());
			}
		}
		...
		if (pe != null && p0 != null)
		{
			...
			function isoLineTo(x, y, ignoreFirst)
			{
				...
				if (elbow)
				{
					if (ignoreFirst)
					{
						last = new mxg.mxPoint(last.x + a1 * h, last.y + a2 * h);
						result.push(last);
					}

					last = new mxg.mxPoint(last.x + b1 * v, last.y + b2 * v);
					result.push(last);
				}
				else
				{
			...
			if (pt == null)
			{
				pt = new mxg.mxPoint(p0.x + (pe.x - p0.x) / 2, p0.y + (pe.y - p0.y) / 2);
			}
	 ...
	 Graph.prototype.createEdgeHandler = function(state, edgeStyle)
	 {
	 	...
	 	{
	 		var handler = new mxg.mxElbowEdgeHandler(state);
	...
	mxRectangleShape.prototype.constraints = [new mxg.mxConnectionConstraint(new mxg.mxPoint(0.25, 0), true),
	                                          new mxg.mxConnectionConstraint(new mxg.mxPoint(0.5, 0), true),
	                                          new mxg.mxConnectionConstraint(new mxg.mxPoint(0.75, 0), true),
	        	              		 new mxg.mxConnectionConstraint(new mxg.mxPoint(0, 0.25), true),
	        	              		 new mxg.mxConnectionConstraint(new mxg.mxPoint(0, 0.5), true),
	        	              		 new mxg.mxConnectionConstraint(new mxg.mxPoint(0, 0.75), true),
	        	            		 new mxg.mxConnectionConstraint(new mxg.mxPoint(1, 0.25), true),
	        	            		 new mxg.mxConnectionConstraint(new mxg.mxPoint(1, 0.5), true),
	        	            		 new mxg.mxConnectionConstraint(new mxg.mxPoint(1, 0.75), true),
	        	            		 new mxg.mxConnectionConstraint(new mxg.mxPoint(0.25, 1), true),
	        	            		 new mxg.mxConnectionConstraint(new mxg.mxPoint(0.5, 1), true),
	        	            		 new mxg.mxConnectionConstraint(new mxg.mxPoint(0.75, 1), true)];
	mxEllipse.prototype.constraints = [new mxg.mxConnectionConstraint(new mxg.mxPoint(0, 0), true), new mxg.mxConnectionConstraint(new mxg.mxPoint(1, 0), true),
	                                   new mxg.mxConnectionConstraint(new mxg.mxPoint(0, 1), true), new mxg.mxConnectionConstraint(new mxg.mxPoint(1, 1), true),
	                                   new mxg.mxConnectionConstraint(new mxg.mxPoint(0.5, 0), true), new mxg.mxConnectionConstraint(new mxg.mxPoint(0.5, 1), true),
	          	              		   new mxg.mxConnectionConstraint(new mxg.mxPoint(0, 0.5), true), new mxg.mxConnectionConstraint(new mxg.mxPoint(1, 0.5))];
	...
	mxCylinder.prototype.constraints = [new mxg.mxConnectionConstraint(new mxg.mxPoint(0.15, 0.05), false),
                                        new mxg.mxConnectionConstraint(new mxg.mxPoint(0.5, 0), true),
                                        new mxg.mxConnectionConstraint(new mxg.mxPoint(0.85, 0.05), false),
      	              		 new mxg.mxConnectionConstraint(new mxg.mxPoint(0, 0.3), true),
      	              		 new mxg.mxConnectionConstraint(new mxg.mxPoint(0, 0.5), true),
      	              		 new mxg.mxConnectionConstraint(new mxg.mxPoint(0, 0.7), true),
      	            		 new mxg.mxConnectionConstraint(new mxg.mxPoint(1, 0.3), true),
      	            		 new mxg.mxConnectionConstraint(new mxg.mxPoint(1, 0.5), true),
      	            		 new mxg.mxConnectionConstraint(new mxg.mxPoint(1, 0.7), true),
      	            		 new mxg.mxConnectionConstraint(new mxg.mxPoint(0.15, 0.95), false),
      	            		 new mxg.mxConnectionConstraint(new mxg.mxPoint(0.5, 1), true),
      	            		 new mxg.mxConnectionConstraint(new mxg.mxPoint(0.85, 0.95), false)];
	UmlActorShape.prototype.constraints = [new mxg.mxConnectionConstraint(new mxg.mxPoint(0.25, 0.1), false),
	                                          new mxg.mxConnectionConstraint(new mxg.mxPoint(0.5, 0), false),
	                                          new mxg.mxConnectionConstraint(new mxg.mxPoint(0.75, 0.1), false),
	        	              		 new mxg.mxConnectionConstraint(new mxg.mxPoint(0, 1/3), false),
	        	              		 new mxg.mxConnectionConstraint(new mxg.mxPoint(0, 1), false),
	        	            		 new mxg.mxConnectionConstraint(new mxg.mxPoint(1, 1/3), false),
	        	            		 new mxg.mxConnectionConstraint(new mxg.mxPoint(1, 1), false),
	        	            		 new mxg.mxConnectionConstraint(new mxg.mxPoint(0.5, 0.5), false)];
	ComponentShape.prototype.constraints = [new mxg.mxConnectionConstraint(new mxg.mxPoint(0.25, 0), true),
	                                          new mxg.mxConnectionConstraint(new mxg.mxPoint(0.5, 0), true),
	                                          new mxg.mxConnectionConstraint(new mxg.mxPoint(0.75, 0), true),
	        	              		 new mxg.mxConnectionConstraint(new mxg.mxPoint(0, 0.3), true),
	        	              		 new mxg.mxConnectionConstraint(new mxg.mxPoint(0, 0.7), true),
	        	            		 ...
	        	            		 new mxg.mxConnectionConstraint(new mxg.mxPoint(0.5, 1), true),
	        	            		 new mxg.mxConnectionConstraint(new mxg.mxPoint(0.75, 1), true)];
	mxActor.prototype.constraints = [new mxg.mxConnectionConstraint(new mxg.mxPoint(0.5, 0), true),
   	              		 new mxg.mxConnectionConstraint(new mxg.mxPoint(0.25, 0.2), false),
   	              		 new mxg.mxConnectionConstraint(new mxg.mxPoint(0.1, 0.5), false),
   	              		 new mxg.mxConnectionConstraint(new mxg.mxPoint(0, 0.75), true),
   	            		 new mxg.mxConnectionConstraint(new mxg.mxPoint(0.75, 0.25), false),
   	            		 new mxg.mxConnectionConstraint(new mxg.mxPoint(0.9, 0.5), false),
   	            		 new mxg.mxConnectionConstraint(new mxg.mxPoint(1, 0.75), true),
   	            		 new mxg.mxConnectionConstraint(new mxg.mxPoint(0.25, 1), true),
   	            		 new mxg.mxConnectionConstraint(new mxg.mxPoint(0.5, 1), true),
   	            		 new mxg.mxConnectionConstraint(new mxg.mxPoint(0.75, 1), true)];
	SwitchShape.prototype.constraints = [new mxg.mxConnectionConstraint(new mxg.mxPoint(0, 0), false),
                                         new mxg.mxConnectionConstraint(new mxg.mxPoint(0.5, 0.25), false),
                                         new mxg.mxConnectionConstraint(new mxg.mxPoint(1, 0), false),
			       	              		 new mxg.mxConnectionConstraint(new mxg.mxPoint(0.25, 0.5), false),
			       	              		 new mxg.mxConnectionConstraint(new mxg.mxPoint(0.75, 0.5), false),
			       	              		 new mxg.mxConnectionConstraint(new mxg.mxPoint(0, 1), false),
			       	            		 new mxg.mxConnectionConstraint(new mxg.mxPoint(0.5, 0.75), false),
			       	            		 new mxg.mxConnectionConstraint(new mxg.mxPoint(1, 1), false)];
	TapeShape.prototype.constraints = [new mxg.mxConnectionConstraint(new mxg.mxPoint(0, 0.35), false),
	                                   new mxg.mxConnectionConstraint(new mxg.mxPoint(0, 0.5), false),
	                                   new mxg.mxConnectionConstraint(new mxg.mxPoint(0, 0.65), false),
	                                   new mxg.mxConnectionConstraint(new mxg.mxPoint(1, 0.35), false),
		                                new mxg.mxConnectionConstraint(new mxg.mxPoint(1, 0.5), false),
		                                new mxg.mxConnectionConstraint(new mxg.mxPoint(1, 0.65), false),
										new mxg.mxConnectionConstraint(new mxg.mxPoint(0.25, 1), false),
										new mxg.mxConnectionConstraint(new mxg.mxPoint(0.75, 0), false)];
	// TODO: Relative ports
	StepShape.prototype.constraints = [new mxg.mxConnectionConstraint(new mxg.mxPoint(0.25, 0), true),
                                       new mxg.mxConnectionConstraint(new mxg.mxPoint(0.5, 0), true),
                                       new mxg.mxConnectionConstraint(new mxg.mxPoint(0.75, 0), true),
                                       new mxg.mxConnectionConstraint(new mxg.mxPoint(0.25, 1), true),
  	        	            		 	new mxg.mxConnectionConstraint(new mxg.mxPoint(0.5, 1), true),
  	        	            		 	new mxg.mxConnectionConstraint(new mxg.mxPoint(0.75, 1), true),
	                                   new mxg.mxConnectionConstraint(new mxg.mxPoint(0.1, 0.25), false),
	                                   new mxg.mxConnectionConstraint(new mxg.mxPoint(0.2, 0.5), false),
	                                   new mxg.mxConnectionConstraint(new mxg.mxPoint(0.1, 0.75), false),
	                                   new mxg.mxConnectionConstraint(new mxg.mxPoint(0.9, 0.25), false),
		                                new mxg.mxConnectionConstraint(new mxg.mxPoint(1, 0.5), false),
		                                new mxg.mxConnectionConstraint(new mxg.mxPoint(0.9, 0.75), false)];
	mxLine.prototype.constraints = [new mxg.mxConnectionConstraint(new mxg.mxPoint(0, 0.5), false),
	                                new mxg.mxConnectionConstraint(new mxg.mxPoint(0.25, 0.5), false),
	                                new mxg.mxConnectionConstraint(new mxg.mxPoint(0.75, 0.5), false),
									new mxg.mxConnectionConstraint(new mxg.mxPoint(1, 0.5), false)];
	LollipopShape.prototype.constraints = [new mxg.mxConnectionConstraint(new mxg.mxPoint(0.5, 0), false),
										new mxg.mxConnectionConstraint(new mxg.mxPoint(0.5, 1), false)];
	...
	mxTriangle.prototype.constraints = [new mxg.mxConnectionConstraint(new mxg.mxPoint(0, 0.25), true),
	                                    new mxg.mxConnectionConstraint(new mxg.mxPoint(0, 0.5), true),
	                                   new mxg.mxConnectionConstraint(new mxg.mxPoint(0, 0.75), true),
	                                   new mxg.mxConnectionConstraint(new mxg.mxPoint(0.5, 0), true),
	                                   new mxg.mxConnectionConstraint(new mxg.mxPoint(0.5, 1), true),
	                                   new mxg.mxConnectionConstraint(new mxg.mxPoint(1, 0.5), true)];
	mxHexagon.prototype.constraints = [new mxg.mxConnectionConstraint(new mxg.mxPoint(0.375, 0), true),
	                                    new mxg.mxConnectionConstraint(new mxg.mxPoint(0.5, 0), true),
	                                   new mxg.mxConnectionConstraint(new mxg.mxPoint(0.625, 0), true),
	                                   new mxg.mxConnectionConstraint(new mxg.mxPoint(0.125, 0.25), false),
	                                   new mxg.mxConnectionConstraint(new mxg.mxPoint(0, 0.5), true),
	                                   new mxg.mxConnectionConstraint(new mxg.mxPoint(0.125, 0.75), false),
	                                   new mxg.mxConnectionConstraint(new mxg.mxPoint(0.875, 0.25), false),
	                                   new mxg.mxConnectionConstraint(new mxg.mxPoint(0, 0.5), true),
	                                   new mxg.mxConnectionConstraint(new mxg.mxPoint(1, 0.5), true),
	                                   new mxg.mxConnectionConstraint(new mxg.mxPoint(0.875, 0.75), false),
	                                   new mxg.mxConnectionConstraint(new mxg.mxPoint(0.375, 1), true),
	                                    new mxg.mxConnectionConstraint(new mxg.mxPoint(0.5, 1), true),
	                                   new mxg.mxConnectionConstraint(new mxg.mxPoint(0.625, 1), true)];
	mxCloud.prototype.constraints = [new mxg.mxConnectionConstraint(new mxg.mxPoint(0.25, 0.25), false),
	                                 new mxg.mxConnectionConstraint(new mxg.mxPoint(0.4, 0.1), false),
	                                 new mxg.mxConnectionConstraint(new mxg.mxPoint(0.16, 0.55), false),
	                                 new mxg.mxConnectionConstraint(new mxg.mxPoint(0.07, 0.4), false),
	                                 new mxg.mxConnectionConstraint(new mxg.mxPoint(0.31, 0.8), false),
	                                 new mxg.mxConnectionConstraint(new mxg.mxPoint(0.13, 0.77), false),
	                                 new mxg.mxConnectionConstraint(new mxg.mxPoint(0.8, 0.8), false),
	                                 new mxg.mxConnectionConstraint(new mxg.mxPoint(0.55, 0.95), false),
	                                 new mxg.mxConnectionConstraint(new mxg.mxPoint(0.875, 0.5), false),
	                                 new mxg.mxConnectionConstraint(new mxg.mxPoint(0.96, 0.7), false),
	                                 new mxg.mxConnectionConstraint(new mxg.mxPoint(0.625, 0.2), false),
	                                 new mxg.mxConnectionConstraint(new mxg.mxPoint(0.88, 0.25), false)];
	...
	DocumentShape.prototype.constraints = [new mxg.mxConnectionConstraint(new mxg.mxPoint(0.25, 0), true),
	                                          new mxg.mxConnectionConstraint(new mxg.mxPoint(0.5, 0), true),
	                                          new mxg.mxConnectionConstraint(new mxg.mxPoint(0.75, 0), true),
	        	              		 new mxg.mxConnectionConstraint(new mxg.mxPoint(0, 0.25), true),
	        	              		 new mxg.mxConnectionConstraint(new mxg.mxPoint(0, 0.5), true),
	...
	SingleArrowShape.prototype.constraints = [new mxg.mxConnectionConstraint(new mxg.mxPoint(0, 0.5), false),
	                                    new mxg.mxConnectionConstraint(new mxg.mxPoint(1, 0.5), false)];
	DoubleArrowShape.prototype.constraints = [new mxg.mxConnectionConstraint(new mxg.mxPoint(0, 0.5), false),
	  	                                    new mxg.mxConnectionConstraint(new mxg.mxPoint(1, 0.5), false)];
	CrossShape.prototype.constraints = [new mxg.mxConnectionConstraint(new mxg.mxPoint(0, 0.5), false),
	                                    new mxg.mxConnectionConstraint(new mxg.mxPoint(1, 0.5), false),
	                                    new mxg.mxConnectionConstraint(new mxg.mxPoint(0.5, 0), false),
	                                    new mxg.mxConnectionConstraint(new mxg.mxPoint(0.5, 1), false)];
	UmlLifeline.prototype.constraints = null;
	OrShape.prototype.constraints = [new mxg.mxConnectionConstraint(new mxg.mxPoint(0, 0.25), false),
	  	                             new mxg.mxConnectionConstraint(new mxg.mxPoint(0, 0.5), false),
	  	                             new mxg.mxConnectionConstraint(new mxg.mxPoint(0, 0.75), false),
	  	                             new mxg.mxConnectionConstraint(new mxg.mxPoint(1, 0.5), false),
	  	                             new mxg.mxConnectionConstraint(new mxg.mxPoint(0.7, 0.1), false),
	  	                             new mxg.mxConnectionConstraint(new mxg.mxPoint(0.7, 0.9), false)];
	XorShape.prototype.constraints = [new mxg.mxConnectionConstraint(new mxg.mxPoint(0.175, 0.25), false),
	  	                             new mxg.mxConnectionConstraint(new mxg.mxPoint(0.25, 0.5), false),
	  	                             new mxg.mxConnectionConstraint(new mxg.mxPoint(0.175, 0.75), false),
	  	                             new mxg.mxConnectionConstraint(new mxg.mxPoint(1, 0.5), false),
	  	                             new mxg.mxConnectionConstraint(new mxg.mxPoint(0.7, 0.1), false),
	  	                             new mxg.mxConnectionConstraint(new mxg.mxPoint(0.7, 0.9), false)];
})();
